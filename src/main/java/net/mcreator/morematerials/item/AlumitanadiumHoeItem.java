...
public class AlumitanadiumHoeItem extends MorematerialsModElements.ModElement {
	@ObjectHolder("morematerials:alumitanadium_hoe")
	public static final Item block = null;
	public AlumitanadiumHoeItem(MorematerialsModElements instance) {
		super(instance, 170);
	}
