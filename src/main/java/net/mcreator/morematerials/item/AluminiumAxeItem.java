...
public class AluminiumAxeItem extends MorematerialsModElements.ModElement {
	@ObjectHolder("morematerials:aluminium_axe")
	public static final Item block = null;
	public AluminiumAxeItem(MorematerialsModElements instance) {
		super(instance, 104);
	}
