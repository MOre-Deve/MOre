...
public class VanadiumPickaxeItem extends MorematerialsModElements.ModElement {
	@ObjectHolder("morematerials:vanadium_pickaxe")
	public static final Item block = null;
	public VanadiumPickaxeItem(MorematerialsModElements instance) {
		super(instance, 145);
	}
