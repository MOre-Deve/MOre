...
public class AluminiumArmorItem extends MorematerialsModElements.ModElement {
	@ObjectHolder("morematerials:aluminium_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("morematerials:aluminium_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("morematerials:aluminium_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("morematerials:aluminium_armor_boots")
	public static final Item boots = null;
	public AluminiumArmorItem(MorematerialsModElements instance) {
		super(instance, 113);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "morematerials:textures/models/armor/aluminium_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
