...
public class TitaniumIngotItem extends MorematerialsModElements.ModElement {
	@ObjectHolder("morematerials:titanium_ingot")
	public static final Item block = null;
	public TitaniumIngotItem(MorematerialsModElements instance) {
		super(instance, 22);
	}
