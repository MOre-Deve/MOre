...
public class VanadiumSwordItem extends MorematerialsModElements.ModElement {
	@ObjectHolder("morematerials:vanadium_sword")
	public static final Item block = null;
	public VanadiumSwordItem(MorematerialsModElements instance) {
		super(instance, 147);
	}
