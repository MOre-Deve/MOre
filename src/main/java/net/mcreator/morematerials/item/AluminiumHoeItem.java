...
public class AluminiumHoeItem extends MorematerialsModElements.ModElement {
	@ObjectHolder("morematerials:aluminium_hoe")
	public static final Item block = null;
	public AluminiumHoeItem(MorematerialsModElements instance) {
		super(instance, 107);
	}
