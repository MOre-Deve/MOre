...
package net.mcreator.morematerials.block;
...
import net.mcreator.morematerials.item.VanadiumIngotItem;
...
public class VanadiumOreBlock extends MorematerialsModElements.ModElement {
	@ObjectHolder("morematerials:vanadium_ore")
	public static final Block block = null;
	public VanadiumOreBlock(MorematerialsModElements instance) {
		super(instance, 140);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(VanadiumIngotItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("vanadium_ore", "vanadium_ore", blockAt -> {
