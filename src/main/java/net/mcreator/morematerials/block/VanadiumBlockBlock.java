...
public class VanadiumBlockBlock extends MorematerialsModElements.ModElement {
	@ObjectHolder("morematerials:vanadium_block")
	public static final Block block = null;
	public VanadiumBlockBlock(MorematerialsModElements instance) {
		super(instance, 141);
	}
