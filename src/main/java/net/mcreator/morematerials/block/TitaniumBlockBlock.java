...
public class TitaniumBlockBlock extends MorematerialsModElements.ModElement {
	@ObjectHolder("morematerials:titanium_block")
	public static final Block block = null;
	public TitaniumBlockBlock(MorematerialsModElements instance) {
		super(instance, 24);
	}
