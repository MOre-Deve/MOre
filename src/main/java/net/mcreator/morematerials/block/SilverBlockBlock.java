...
public class SilverBlockBlock extends MorematerialsModElements.ModElement {
	@ObjectHolder("morematerials:silver_block")
	public static final Block block = null;
	public SilverBlockBlock(MorematerialsModElements instance) {
		super(instance, 45);
	}
