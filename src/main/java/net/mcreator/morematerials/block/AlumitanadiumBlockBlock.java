...
public class AlumitanadiumBlockBlock extends MorematerialsModElements.ModElement {
	@ObjectHolder("morematerials:alumitanadium_block")
	public static final Block block = null;
	public AlumitanadiumBlockBlock(MorematerialsModElements instance) {
		super(instance, 162);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("alumitanadium_block");
		}
