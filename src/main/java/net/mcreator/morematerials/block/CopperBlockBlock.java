...
public class CopperBlockBlock extends MorematerialsModElements.ModElement {
	@ObjectHolder("morematerials:copper_block")
	public static final Block block = null;
	public CopperBlockBlock(MorematerialsModElements instance) {
		super(instance, 51);
	}
