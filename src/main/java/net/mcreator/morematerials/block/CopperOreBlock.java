...
import net.mcreator.morematerials.item.CopperIngotItem;
...
public class CopperOreBlock extends MorematerialsModElements.ModElement {
	@ObjectHolder("morematerials:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(MorematerialsModElements instance) {
		super(instance, 50);
	}
