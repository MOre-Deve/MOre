...
import net.mcreator.morematerials.item.SilverIngotItem;
...
public class SilverOreBlock extends MorematerialsModElements.ModElement {
	@ObjectHolder("morematerials:silver_ore")
	public static final Block block = null;
	public SilverOreBlock(MorematerialsModElements instance) {
		super(instance, 44);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 3)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(4, 1, 1, 27))));
		}
	}
}
