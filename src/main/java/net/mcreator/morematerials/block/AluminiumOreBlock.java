...
import net.mcreator.morematerials.item.AluminiumIngotItem;
...
public class AluminiumOreBlock extends MorematerialsModElements.ModElement {
	@ObjectHolder("morematerials:aluminium_ore")
	public static final Block block = null;
	public AluminiumOreBlock(MorematerialsModElements instance) {
		super(instance, 98);
	}
