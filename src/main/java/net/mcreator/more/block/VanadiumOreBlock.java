...
import net.mcreator.more.item.VanadiumIngotItem;
...
public class VanadiumOreBlock extends MoreModElements.ModElement {
	@ObjectHolder("more:vanadium_ore")
	public static final Block block = null;
	public VanadiumOreBlock(MoreModElements instance) {
		super(instance, 140);
	}
