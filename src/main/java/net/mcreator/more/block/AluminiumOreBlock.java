...
import net.mcreator.more.item.AluminiumIngotItem;
...
public class AluminiumOreBlock extends MoreModElements.ModElement {
	@ObjectHolder("more:aluminium_ore")
	public static final Block block = null;
	public AluminiumOreBlock(MoreModElements instance) {
		super(instance, 98);
	}
