...
import net.mcreator.more.item.SilverIngotItem;
...
public class SilverOreBlock extends MoreModElements.ModElement {
	@ObjectHolder("more:silver_ore")
	public static final Block block = null;
	public SilverOreBlock(MoreModElements instance) {
		super(instance, 44);
	}
