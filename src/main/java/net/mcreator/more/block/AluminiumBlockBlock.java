...
public class AluminiumBlockBlock extends MoreModElements.ModElement {
	@ObjectHolder("more:aluminium_block")
	public static final Block block = null;
	public AluminiumBlockBlock(MoreModElements instance) {
		super(instance, 99);
	}
