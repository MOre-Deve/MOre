...
public class AlumitanadiumBlockBlock extends MoreModElements.ModElement {
	@ObjectHolder("more:alumitanadium_block")
	public static final Block block = null;
	public AlumitanadiumBlockBlock(MoreModElements instance) {
		super(instance, 162);
	}
