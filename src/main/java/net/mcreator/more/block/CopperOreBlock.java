...
import net.mcreator.more.item.CopperIngotItem;
...
public class CopperOreBlock extends MoreModElements.ModElement {
	@ObjectHolder("more:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(MoreModElements instance) {
		super(instance, 50);
	}
