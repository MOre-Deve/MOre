...
public class TPickaxeItem extends MoreModElements.ModElement {
	@ObjectHolder("more:t_pickaxe")
	public static final Item block = null;
	public TPickaxeItem(MoreModElements instance) {
		super(instance, 13);
	}
