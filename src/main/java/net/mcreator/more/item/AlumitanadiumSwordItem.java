...
public class AlumitanadiumSwordItem extends MoreModElements.ModElement {
	@ObjectHolder("more:alumitanadium_sword")
	public static final Item block = null;
	public AlumitanadiumSwordItem(MoreModElements instance) {
		super(instance, 168);
	}
