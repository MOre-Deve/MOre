...
public class AlumitanadiumPickaxeItem extends MoreModElements.ModElement {
	@ObjectHolder("more:alumitanadium_pickaxe")
	public static final Item block = null;
	public AlumitanadiumPickaxeItem(MoreModElements instance) {
		super(instance, 166);
	}
