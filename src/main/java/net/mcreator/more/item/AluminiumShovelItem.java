...
public class AluminiumShovelItem extends MoreModElements.ModElement {
	@ObjectHolder("more:aluminium_shovel")
	public static final Item block = null;
	public AluminiumShovelItem(MoreModElements instance) {
		super(instance, 106);
	}
