...
public class AlumitanadiumAxeItem extends MoreModElements.ModElement {
	@ObjectHolder("more:alumitanadium_axe")
	public static final Item block = null;
	public AlumitanadiumAxeItem(MoreModElements instance) {
		super(instance, 167);
	}
