...
public class TitaniumPickaxeItem extends MoreModElements.ModElement {
	@ObjectHolder("more:titanium_pickaxe")
	public static final Item block = null;
	public TitaniumPickaxeItem(MoreModElements instance) {
		super(instance, 28);
	}
