...
public class TShovelItem extends MoreModElements.ModElement {
	@ObjectHolder("more:t_shovel")
	public static final Item block = null;
	public TShovelItem(MoreModElements instance) {
		super(instance, 16);
	}
